...
- The active roadmap is the ordered Phase 2 Facelift lane in `docs/phase-roadmap.md`. After F26-07, P2F-06 is the sole `READY` task; do not select stale Fall work or infer readiness from satisfied dependencies. Keep exactly one task `READY` at a time.
