...
- CI includes `validate`, `check:links`, and `test:tools`; the P2F-02 baseline is 143/143 tool tests passing.
...
- The active roadmap is the ordered Phase 2 Facelift lane in `docs/phase-roadmap.md`. After P2F-02, P2F-03 is the sole `READY` task; do not select stale F26-04 work or infer readiness from satisfied dependencies. Keep exactly one task `READY` at a time.
