...
- CI includes `validate`, `check:links`, and `test:tools`; the P2F-04 baseline is 154/154 tool tests passing.
...
- The active roadmap is the ordered Phase 2 Facelift lane in `docs/phase-roadmap.md`. After P2F-04, P2F-05 is the sole `READY` task; do not select stale F26-04 work or infer readiness from satisfied dependencies. Keep exactly one task `READY` at a time.
