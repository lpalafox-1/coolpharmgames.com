// tools/validator-core.mjs
// Internal shared validator core. The single source of schema compilation and
...
export function validateQuizSchema(data) {
  ...
  return { valid, errors: valid ? [] : [...(compiledSchema.errors || [])] };
}
...
export function validateQuizSemantics(quiz, fileName) {
  const errors = [];
