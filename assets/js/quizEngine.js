...
function createQuestion(drug, allDrugs) {
  ...
  switch (type) {
    case "brand-generic":
      // ENFORCE: Brand/Generic MUST be 'short' (Fill-in-the-blank)
      q = {
        type: "short",
    ...
    case "generic-brand":
      ...
      break;
    case "class":
      // ENFORCE: Class MUST be 'mcq' (Multiple Choice)
      q = createMCQ(
      ...
      break;
    case "category":
      // ENFORCE: Category MUST be 'mcq' (Multiple Choice)
      q = createMCQ(
      ...
      break;
    case "moa":
      // ENFORCE: MOA MUST be 'mcq' (Multiple Choice)
      q = createMCQ(
