...
const state = { 
    ...
    currentScale: 1.0 // Track font scaling for desktop
};
    ...
    if (els.helpShortcuts) {
        els.helpShortcuts.onpointerdown = (e) => {
            ...
            if (modal) {
                ...
                // Update text to include all shortcuts
                modal.querySelector('.space-y-5').innerHTML = `
                  <div class="flex justify-between items-center"><span>Next / Check Answer</span><kbd>Enter</kbd></div>
                  <div class="flex justify-between items-center"><span>Navigate Questions</span><kbd>← / →</kbd></div>
                  <div class="flex justify-between items-center"><span>Jump to Q 1-10</span><kbd>1 - 0</kbd></div>
